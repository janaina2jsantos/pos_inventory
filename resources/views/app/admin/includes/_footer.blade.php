	...
	<script type="text/javascript" src="{{ asset('dist/assets/plugins/custom/prismjs/prismjs.bundle5883.js?v=7.2.9') }}"></script>
	<script type="text/javascript" src="{{ asset('dist/assets/js/scripts.bundle5883.js?v=7.2.9') }}"></script>
	<script type="text/javascript" src="{{ asset('dist/assets/js/pages/widgets5883.js?v=7.2.9') }}"></script>
	<script type="text/javascript" src="{{ asset('dist/assets/js/pages/crud/file-upload/image-input5883.js?v=7.2.9') }}"></script>
	<!-- <script src="../theme/html/demo1/dist/assets/plugins/custom/fullcalendar/fullcalendar.bundle5883.js?v=7.2.9"></script> -->
