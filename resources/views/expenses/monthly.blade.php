		...
		<div class="card card-custom">
			...
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<a class="btn btn-info blind-link"><strong id="expensesDate">{{ \Carbon\Carbon::now()->format('F') }} Expenses</strong></a>
				</div>
							...
							<div class="row align-items-center">
								...
								<div class="col-md-6 my-2 my-md-0">
									<div class="d-flex align-items-center">
										...
										<input type="month" class="form-control" name="month" id="kt_datatable_search_month" value=" old('month') }}" />
									</div>
								</div>
							</div>
						</div>
...
@section('scripts')
    <script src="{{ asset('js/pages/expenses/monthly.js') }}"></script>
@stop
