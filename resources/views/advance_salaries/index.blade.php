		...
		<div class="card card-custom">
			...
			<div class="card-header flex-wrap border-0 pt-6 pb-0">
				<div class="card-title">
					<h3 class="card-label">Advance Salaries</h3>
				</div>
				<div class="card-toolbar">
					...
					<a href="{{ route('advance-salaries.create') }}" class="btn btn-primary font-weight-bolder">
					<span class="svg-icon svg-icon-md">
						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
								<rect x="0" y="0" width="24" height="24" />
			...
			<div class="card-body">
				...
				<!--datatable-->
				<div class="datatable-advance-salaries datatable-bordered datatable-head-custom" id="tableAdvanceSalaries"></div>
			</div>
		</div>
	</div>
@stop
...
@section('scripts')
    <script src="{{ asset('js/pages/advance_salaries/index.js') }}"></script>
@stop
